package com.example.administrator.bannerdemo.views;
...
import com.example.administrator.bannerdemo.R;
...
public class BannerLayout extends RelativeLayout
{
    ...
    //我加的
    private OnBannerItemPosionListener onBannerItemPosionListener;
    ...
    private void setViews(final List<View> views)
    {
        ...
        pager.addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener()
        {
            ...
            public void onPageSelected(int position)
            {
                ...
                //我觉得这块加个接口把位置传过去（达到一些文字的变化），不错
                // int a= position % itemCount;
                if (onBannerItemPosionListener!=null)
                    onBannerItemPosionListener.onItemPosition(position % itemCount);
    ...
    public void setOnBannerItemPosionListener(OnBannerItemPosionListener OnBannerItemPosionListener)
    {
        this.onBannerItemPosionListener=OnBannerItemPosionListener;
    }
    public interface OnBannerItemPosionListener
    {
